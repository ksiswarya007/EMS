...
const TaskListNumbers = ({ data }) => {
  if (!data || !data.taskCounts) {
    return <div className='text-center mt-5 text-gray-600'>Loading task stats...</div>;
  }

  return (
    <div className='flex mt-10 justify-between gap-5 screen'>
      <div className='rounded-xl w-[23%] py-6 px-9 bg-blue-400'>
        <h2 className='text-2xl font-semibold'>{data.taskCounts.newTask}</h2>
        <h3 className='text-xl font-medium'>New Task</h3>
      </div>
      <div className='rounded-xl w-[23%] py-6 px-9 bg-green-400'>
        <h2 className='text-2xl font-semibold'>{data.taskCounts.completed}</h2>
        <h3 className='text-xl font-medium'>Completed Task</h3>
      </div>
      <div className='rounded-xl w-[23%] py-6 px-9 bg-red-400'>
      ...
      <div className='rounded-xl w-[23%] py-6 px-9 bg-orange-400'>
